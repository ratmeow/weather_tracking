...
class LocationDAO:
    ...
    async def add(self, location_data: LocationDTO) -> Optional[LocationORM]:
    ...
    async def get(self, location_data: LocationDTO) -> LocationORM:
    ...
    async def add_to_user(self, user_id: int, location_id: int) -> None:
    ...
    async def delete(self, user_id: int, location_data: LocationDTO) -> None:
        location = await self.get(location_data=location_data)
    ...
    async def get_by_user_id(self, user_id: int) -> list[LocationORM]:
